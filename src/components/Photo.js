function Photo(props) {
    return(
        <div className="d-flex flex-column align-items-center align-items-lg-start flex-lg-row mb-4">
            {props.photo.media_type==="image"?<img src={props.photo.url} alt={props.photo.title} className="w-100 rounded mb-3" style={{"maxWidth" : "50%"}}/>:<iframe src={props.photo.url} controls title="NASA Video"></iframe>}
